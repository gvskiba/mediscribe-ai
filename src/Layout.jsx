  ...
  return (
    <div className="bg-white flex flex-col h-screen">
      ...
      {(() => {
        ...
        return (
          <main
            className={isDark ? 'bg-[#050f1e]' : isHome ? '' : currentPageName === 'CommandCenter' ? '' : 'pt-32 lg:pt-20'}
            style={{ marginLeft: (showSidebar && !isHome && currentPageName !== 'CommandCenter') ? 72 : 0, paddingTop: '0', flex: 1, overflowY: 'auto' }}
          >
