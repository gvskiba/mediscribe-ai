...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Main Content */}
      <main 
        className={`flex-1 ${currentPageName === 'NoteDetail' ? 'bg-[#050f1e]' : currentPageName === 'Dashboard' ? 'bg-[#050f1e]' : currentPageName === 'Home' ? '' : ''}`}
        style={{ 
          paddingTop: showSidebar ? '88px' : '0px',
          paddingLeft: showSidebar ? '80px' : '0px'
        }}
      >
