...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Main Content */}
      <main className={`flex-1 ${currentPageName === 'NoteDetail' || currentPageName === 'Dashboard' || currentPageName === 'Calendar' || currentPageName === 'NotesLibrary' || currentPageName === 'PatientDashboard' || currentPageName === 'ClinicalGuidelines' || currentPageName === 'Calculators' || currentPageName === 'MedicalNews' || currentPageName === 'AppSettings' || currentPageName === 'Procedures' ? 'bg-[#050f1e] pt-20' : currentPageName === 'Home' ? 'p-0 m-0' : 'pt-32 lg:pt-20'}`}
 style={{ marginLeft: (showSidebar && currentPageName !== 'Home') ? 64 : 0, minHeight: '100vh' }}>
        <div className={currentPageName === 'NoteDetail' || currentPageName === 'Dashboard' || currentPageName === 'Calendar' || currentPageName === 'NotesLibrary' || currentPageName === 'PatientDashboard' || currentPageName === 'ClinicalGuidelines' || currentPageName === 'Calculators' || currentPageName === 'MedicalNews' || currentPageName === 'AppSettings' || currentPageName === 'Procedures' || currentPageName === 'Home' ? 'h-full w-full p-0 m-0' : 'p-4 md:p-8 max-w-7xl mx-auto'} style={{paddingLeft: currentPageName === 'PatientDashboard' ? '16px' : undefined, paddingRight: currentPageName === 'PatientDashboard' ? '16px' : undefined}}>
          {children}
        </div>
        {/* Medical AI Chatbot */}
        <MedicalChatbot />
