  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        {/* Main Content */}
        <main className={`flex-1 ${currentPageName === 'NoteDetail' ? 'bg-[#050f1e]' : currentPageName === 'Dashboard' ? 'bg-[#050f1e]' : currentPageName === 'Home' ? '' : 'pt-32 lg:pt-20'}`} style={{ marginLeft: showSidebar ? '80px' : '0px' }}>
