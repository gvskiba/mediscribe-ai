...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="bg-white flex flex-col h-screen">
      ...
      {/* Main Content */}
      {(() => {
        const darkPages = ['NoteDetail','ClinicalNoteStudio','Dashboard','Calendar','NotesLibrary','PatientDashboard','ClinicalGuidelines','Calculators','MedicalNews','AppSettings','Procedures','Shift','SoapCompiler','SoapCompilerStandalone','AntibioticStewardship','PediatricDosing','DrugReference','MedicationReference','CMELearningCenter','DischargePlanning','OrderSetBuilder','NoteTemplates','CustomTemplates','AddendumManager','LiveTranscription','CantMissDiagnoses','BillingDashboard','DrugsBugs','UserPreferences','DiagnosticStewardship','CommandCenter','NursingFlowsheet','AutoCoder','ClinicalDecisionSupport','KnowledgeBaseV2'];
        ...
        return (
          <main
            ...
            style={{ marginLeft: (showSidebar && !isHome && currentPageName !== 'MedicationReference' && currentPageName !== 'KnowledgeBaseV2') ? 72 : 0, paddingTop: (currentPageName !== 'Home' && currentPageName !== 'ClinicalNoteStudio' && currentPageName !== 'NoteDetail' && currentPageName !== 'NoteTemplates' && currentPageName !== 'CustomTemplates' && currentPageName !== 'PatientDashboard' && currentPageName !== 'DischargePlanning' && currentPageName !== 'UserPreferences' && currentPageName !== 'DiagnosticStewardship' && currentPageName !== 'NoteCreationHub' && currentPageName !== 'Results' && currentPageName !== 'NursingFlowsheet' && currentPageName !== 'AutoCoder' && currentPageName !== 'ClinicalDecisionSupport' && currentPageName !== 'DrugReference' && currentPageName !== 'MedicationReference' && currentPageName !== 'KnowledgeBaseV2') ? '48px' : '0', flex: 1, overflowY: 'auto' }}
          >
