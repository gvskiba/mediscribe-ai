...
export const HUBS = [
  ...
  { id: "order-generator", route: "/EDOrderHub", icon: "📋", abbr: "ORDERS", title: "Order Generator", subtitle: "Weight-based dosing · Copy-paste order text · Bundles · CPOE bridge", category: "Pharmacology", ...palette("#3b9eff"), stats: ["30+ Drugs", "Weight-Based", "Bundle Launch"], badge: "CPOE", priority: 41.5, essential: false, live: true, note: "DEAD ROUTE: /order-generator not mounted. App.jsx has /EDOrderHub + /OrderDashboard — re-point here, or delete." },
