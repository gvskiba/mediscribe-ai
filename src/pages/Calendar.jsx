...
export default function CalendarPage() {
  ...
  return (
    <div style={{ background: config.colors.background, width: "100%", height: "calc(100vh - 88px)", marginTop: "88px", marginLeft: "80px", color: config.colors.text, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      {/* Compact Header */}
      <div style={{ height: "0px", background: config.colors.surface, borderBottom: `1px solid ${config.colors.border}`, padding: "0 20px", display: "none", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
