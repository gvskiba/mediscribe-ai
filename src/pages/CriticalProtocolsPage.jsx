...
const CATEGORIES = [
  ...
  },
  {
    ...
    protocols: [
      ...
      { name: "Rhabdomyolysis", desc: "Aggressive IVF protocol · urine alkalization · CK trending · complication watch", page: "RhabdomyolysisHub" },
    ],
  },
  {
    label: "Cardiac / Pulmonary",
    color: T.blue,
    icon: "❤️",
    protocols: [
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "24px 20px 0" }}>
        ...
        <h1 style={{ fontFamily: T.serif, fontSize: 28, fontWeight: 700, margin: "0 0 6px", lineHeight: 1.1 }}>
          Critical Protocols
        </h1>
        <p style={{ color: T.muted, fontSize: 13, margin: "0 0 20px" }}>
          Evidence-based ED resuscitation pathways · {total} protocols
        </p>
        ...
        <div style={{ position: "relative", marginBottom: 24 }}>
          ...
          <input
            ...
            style={{
              ...
              background: T.glassMid,
              border: `1px solid ${query ? T.teal + "60" : T.border}`,
              borderRadius: 10,
              color: T.white,
              fontSize: 13,
              fontFamily: T.sans,
          ...
          {query && (
            <button
              onClick={() => setQuery("")}
              style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: T.dim, cursor: "pointer", fontSize: 16, lineHeight: 1 }}
            >
              ×
            </button>
          )}
              ...
              {cat.protocols.map(p => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Text */}
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: T.white, marginBottom: 3, letterSpacing: "0.01em" }}>
                        {p.name}
                      </div>
                    ...
                    {/* Arrow */}
                    <div style={{ fontSize: 16, color: isHovered ? cat.color : T.dim, transition: "color 0.18s", flexShrink: 0 }}>
                      →
                    </div>
                  </div>
                );
