...
const CATEGORIES = [
  {
    ...
    protocols: [
      ...
      { name: "Cardiogenic Shock",               desc: "Hemodynamic profiles · inotropes · MCS · IABP · Impella decision tree",          page: "CardiogenicShockHub",     status: "live" },
      { name: "Massive GI Bleed",                desc: "Resuscitation · transfusion ratio · endoscopy timing · variceal vs non-variceal", page: "MassiveGIBleedHub",       status: "live" },
      { name: "Massive Transfusion Protocol",    desc: "1:1:1 ratio · TXA dosing · damage control resuscitation · product triggers",     page: "MTPHub",                  status: "live" },
      { name: "Heat Stroke",                     desc: "Classic vs exertional · cooling protocols · end-organ damage · ICU triggers",    page: "HeatStrokeHub",           status: "live" },
    ],
  },
  {
    ...
    protocols: [
      ...
      { name: "Acute Ischemic Stroke",           desc: "tPA eligibility · thrombectomy window · NIHSS · BP management · imaging",        page: "AcuteIschemicStrokeHub",  status: "live" },
      { name: "Subarachnoid Hemorrhage",         desc: "Hunt-Hess grading · nimodipine · vasospasm · neurosurgery triggers",             page: "SAHHub",                  status: "live" },
      { name: "Myasthenic Crisis",               desc: "Cholinergic vs myasthenic · IVIG · plasmapheresis · ventilator weaning",         page: "MyasthenicCrisisHub",     status: "live" },
    ],
  },
  {
    ...
    protocols: [
      ...
      { name: "Severe Hyponatremia",             desc: "Symptomatic correction · 3% NaCl bolus · ODS prevention · SIADH workup",        page: "HyponatremiaHub",         status: "live" },
      { name: "Hypercalcemic Crisis",            desc: "Saline diuresis · bisphosphonates · calcitonin · dialysis · malignancy",        page: "HypercalcemiaHub",        status: "live" },
      { name: "Neuroleptic Malignant Syndrome",  desc: "NMS vs serotonin syndrome · bromocriptine · dantrolene · cooling protocol",     page: "NMSHub",                  status: "live" },
    ],
  },
  {
    ...
    protocols: [
      ...
      { name: "STEMI",                           desc: "Door-to-balloon · lytics decision · cath lab activation · reperfusion",         page: "STEMIHub",                status: "live" },
      { name: "Cardiac Tamponade",               desc: "Beck's triad · echo findings · pericardiocentesis technique · drainage",        page: "CardiacTamponadeHub",     status: "live" },
      { name: "Status Asthmaticus",              desc: "NIPPV · heliox · magnesium · ketamine RSI · ventilator strategy",              page: "StatusAsthmaticusHub",    status: "live" },
      { name: "Tension Pneumothorax",            desc: "Clinical diagnosis · needle vs finger thoracostomy · tube thoracostomy",        page: "TensionPneumothoraxHub",  status: "live" },
    ],
  },
  {
  ...
  },
  {
    ...
    protocols: [
      { name: "TTP / HUS",                       desc: "ADAMTS13 · plasmapheresis urgency · avoid platelets · blood smear",            page: "TTPHub",                  status: "live" },
      { name: "Anticoagulant Reversal",           desc: "4-factor PCC · andexanet · idarucizumab · Vitamin K · warfarin vs DOAC",      page: "AnticoagulantReversalHub",status: "live" },
      { name: "Sickle Cell Crisis",              desc: "Vaso-occlusive · acute chest syndrome · exchange transfusion · hydroxyurea",   page: "SickleCellHub",          status: "live" },
    ],
  },
  {
    label: "Obstetric", color: T.pink, icon: "🤰",
    protocols: [
      { name: "Postpartum Hemorrhage",           desc: "Uterotonic ladder · massive transfusion · surgical escalation · Bakri balloon", page: "PostPartumHemorrhageHub", status: "live" },
      { name: "HELLP Syndrome",                  desc: "Diagnosis criteria · delivery timing · magnesium · steroids · platelet threshold",page: "HELLPHub",              status: "live" },
    ],
  },
];
