...
Generated by Notrya AI Pre-Procedure Reconciliation. Confirm with proceduralist and anesthesiologist as appropriate.`);
  ...
  const S = {
    root:{ fontFamily:"'DM Sans',system-ui,sans-serif", background:G.navy, height:"100vh", color:G.text, display:"flex", flexDirection:"column", position:"relative", overflow:"hidden" },
