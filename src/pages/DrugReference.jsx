...
Generated by Notrya AI Pre-Procedure Reconciliation. Confirm with proceduralist and anesthesiologist as appropriate.`);
  ...
  const S = {
    ...
    ph:{ position:"sticky", top:0, zIndex:10, padding:"16px 28px 12px", borderBottom:`1px solid rgba(30,58,95,.6)`, background:"rgba(11,29,53,.95)", backdropFilter:"blur(8px)", display:"flex", alignItems:"center", justifyContent:"space-between", gap:16, flexWrap:"wrap" },
