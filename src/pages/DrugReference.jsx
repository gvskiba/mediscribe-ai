...
Generated by Notrya AI Pre-Procedure Reconciliation. Confirm with proceduralist and anesthesiologist as appropriate.`);
  ...
  const S = {
    root:{ fontFamily:"'DM Sans',system-ui,sans-serif", background:G.navy, minHeight:"100%", color:G.text, display:"flex", flexDirection:"column", position:"relative" },
    ...
    centerPanel:{ overflowY:"auto", background:"rgba(5,10,20,.3)", display:"flex", flexDirection:"column" },
    rightPanel:{ borderLeft:`1px solid ${G.border}`, background:"rgba(11,29,53,.3)", display:"flex", flexDirection:"column", overflow:"hidden" },
    ...
    return (
      <div style={{ padding:24, display:"flex", flexDirection:"column", gap:18 }}>
        ...
        <div style={S.ddSection}>
          ...
          <table style={S.table}>
            <thead><tr><th style={S.th}>Indication</th><th style={S.th}>Dose</th><th style={S.th}>Route</th><th style={S.th}>Duration</th><th style={S.th}>Notes</th></tr></thead>
  ...
  return (
    <div style={S.root}>
      ...
      {/* MAIN LAYOUT */}
      <div style={{ ...S.mainLayout, height:"calc(100vh - 140px)" }}>
