    ...
    <div style={S.root}>
      ...
      <div style={S.ph}>
        <div style={{ display:"flex", alignItems:"center", gap:14 }}>
          <button onClick={() => navigate(createPageUrl('DrugsBugs'))} style={{ padding:"8px 14px", borderRadius:8, fontSize:12, fontWeight:700, cursor:"pointer", background:"transparent", border:`1px solid ${G.border}`, color:G.dim, display:"flex", alignItems:"center", gap:6 }}>← Back to Drugs & Bugs</button>
