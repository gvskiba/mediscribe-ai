...
function RxBuilder({ drug, onSign, onCancel, patientWeight, patientAgeMonths, patientAllergies, activeRx }) {
  ...
  // Reset form and tab when drug changes
  useEffect(() => {
    setForm(defaultForm());
    setActiveTab("dosing");
  }, [drug.id]);
        ...
        <div style={{ display:"flex",alignItems:"center",gap:12,flexWrap:"wrap" }}>
          ...
          <div style={{ display:"flex",gap:8,alignItems:"center",flexWrap:"wrap" }}>
            ...
            <div style={{ ...deep({borderRadius:8}),padding:"4px 10px",display:"flex",alignItems:"center",gap:6 }}>
              ...
              {patientAgeMonths && <span style={{ fontFamily:"DM Sans",fontSize:10,color:T.teal }}>{Math.floor((parseFloat(patientAgeMonths)||0)/12)}y{Math.round((parseFloat(patientAgeMonths)||0)%12)}m</span>}
            </div>
