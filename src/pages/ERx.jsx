...
export default function ERxHub({ embedded, patientAllergiesFromParent, patientWeightFromParent }) {
  ...
  const TABS = [
    ...
    { id: "pdmp",      label: "PDMP",                               color: T.coral  },
          ...
          <div style={{ padding:"16px 20px", overflowY:"auto", display:"flex", flexDirection:"column", gap:14 }}>
            <div style={{ ...glass({borderRadius:12, background:"rgba(255,107,107,0.07)", borderColor:"rgba(255,107,107,0.3)"}), padding:"16px 18px" }}>
              ...
              <div style={{ fontFamily:"DM Sans", fontSize:13, color:T.txt2, lineHeight:1.7 }}>
                PDMP review is <strong style={{color:T.txt}}>mandatory before prescribing any controlled substance (Schedule II–V)</strong>. eRx enforces acknowledgment of PDMP review within the prescription workflow for all controlled substances.
              </div>
            </div>
