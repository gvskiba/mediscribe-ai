...
const _s = {
  ...
  setupDone:    false,
  scratchpad:   "",
  activePatId:  null,         // set by NewPatientInput on mount
};
const _subs = new Set();
...
const GROUPS = [
  { label:"Critical Care", color:T.coral, hubs:[
    { id:"sepsis",    route:"/sepsis-hub",          icon:"🦠", title:"Sepsis Hub",          badge:"SSC 2021",    color:T.coral,  tags:["sepsis","qsofa","hour-1","bundle","antibiotics","sirs"],                    features:["qSOFA / SIRS","Hour-1 Bundle","Source ABX","AI Resistance"],      desc:"Sepsis-3 criteria, qSOFA, Hour-1 Bundle, source-based antibiotic tiers, AI resistance lookup." },
  ...
  { label:"Diagnostics", color:T.cyan, hubs:[
    { id:"ecg",       route:"/ecg-hub",             icon:"📈", title:"ECG Hub",              badge:"ACC/AHA",     color:T.cyan,   tags:["ecg","ekg","stemi","qtc","sgarbossa","arrhythmia","lbbb"],                  features:["Waveform Library","STEMI Equivalents","QTc Calc","Sgarbossa"],      desc:"SVG waveform library, STEMI equivalents, QTc calculator, Sgarbossa criteria, 8-step read." },
    { id:"labs",      route:"/lab-interpreter",     icon:"🧪", title:"Lab Interpreter",      badge:"AI·PASTE",    color:T.green,  tags:["labs","cbc","bmp","lft","anion gap","ai interpretation"],                  features:["BMP / CBC / LFTs","Anion Gap / P/F","AI Interpretation","Critical Values"],desc:"Manual entry or paste-parse. AI interpretation with differential and action items." },
    { id:"scores",    route:"/score-hub",           icon:"🎯", title:"Score Hub",            badge:"12+ TOOLS",   color:T.blue,   tags:["scores","heart","wells","perc","curb-65","ottawa","nexus","gcs"],             features:["HEART / Wells","Ottawa / NEXUS","CURB-65 / GCS","ABCD2"],           desc:"12+ validated scores auto-populated from encounter: HEART, Wells, Ottawa, GCS, ABCD2." },
    { id:"pocus",     route:"/pocus-hub",           icon:"🔊", title:"POCUS Hub",            badge:"BEDSIDE",     color:T.cyan,   tags:["pocus","ultrasound","fast","efast","cardiac","lung","dvt","aaa"],           features:["Cardiac / Lung","FAST / eFAST","DVT Protocol","Soft Tissue"],       desc:"Cardiac, lung, FAST/eFAST, DVT, AAA protocols with standard views and image gallery." },
  ...
  { label:"Pharmacology", color:T.teal, hubs:[
    ...
    { id:"weightdose",route:"/weight-dose",          icon:"⚖️", title:"Weight Dose Hub",      badge:"30 DRUGS",    color:T.teal,   tags:["weight","dosing","rsi","vasopressors","infusion","reversal","pals"],         features:["RSI / Vasopressors","Live Infusion Calc","Reversal Agents","PALS"],  desc:"30 critical drugs, vasopressor weight-based dosing, live infusion calculator, PALS mode." },
    { id:"tox",       route:"/tox-hub",             icon:"☠️", title:"Tox Hub",              badge:"ANTIDOTES",   color:T.coral,  tags:["tox","overdose","antidotes","rumack","toxidrome","co","opioid"],             features:["16 Antidotes","Rumack-Matthew","10 Protocols","CO Protocol"],        desc:"16 antidotes with dosing, Rumack-Matthew nomogram, toxidrome table, CO protocol.", updates:["CO Protocol ACEP 2025"] },
  ...
  { label:"Subspecialty", color:T.rose, hubs:[
    ...
    { id:"peds",      route:"/peds-hub",        isNew:true,        icon:"🧒", title:"Pediatric Hub",        badge:"PECARN",      color:T.green,  tags:["pediatric","peds","broselow","pecarn","fever","rochester","westley","croup"],features:["Broselow / Vitals","PECARN Head CT","Fever Workup","PALS Dosing"],  desc:"Broselow, age-based vitals, PECARN, Rochester fever criteria, PALS weight-based dosing." },
  ...
  { label:"Procedures", color:T.orange, hubs:[
    ...
    { id:"wound",     route:"/wound-hub",           icon:"🩹", title:"Wound Hub",            badge:"CLOSURE",     color:T.orange, tags:["wound","laceration","closure","suture","irrigation"],                        features:["Closure Selection","Suture Sizing","Wound Care","Irrigation"],       desc:"Laceration management, closure type selection, suture sizing, wound care instructions." },
    { id:"procedure", route:"/procedure-hub",       icon:"🔧", title:"Procedure Hub",        badge:"CPT CODES",   color:T.orange, tags:["procedure","cpt","consent","technique","lp","central line"],                 features:["Procedure Notes","CPT Codes","Consent Templates","Step-by-Step"],    desc:"Procedure note templates with CPT coding, consent guidance, and step-by-step technique." },
  ...
  { label:"Documentation & Tools", color:T.purple, hubs:[
    { id:"autocoder", route:"/AutoCoder",        icon:"📋", title:"Autocoder Hub",        badge:"AI-POWERED",  color:T.purple, tags:["coding","icd-10","cpt","e&m","billing","ai"],                               features:["ICD-10 / CPT","E&M Calculator","Code Cart","AI Autocoder"],         desc:"AI-powered ICD-10/CPT coding, E&M level calculator, code cart, transmit-ready summaries." },
    { id:"discharge", route:"/discharge-hub",       icon:"🚪", title:"Discharge Hub",        badge:"AI-POWERED",  color:T.gold,   tags:["discharge","instructions","ai","patient education","return precautions"],   features:["AI Instructions","Diagnosis-Specific","Med Reconciliation","Print"], desc:"AI-generated discharge instructions tailored to diagnosis, medications, and follow-up plan." },
