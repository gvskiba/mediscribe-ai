...
const GROUPS = [
  ...
  { label:"Pharmacology", color:T.teal, hubs:[
    { id:"erx",       route:"/unified-pharma",     icon:"💊",  title:"Pharmacology Hub",     badge:"UNIFIED",     color:T.teal,   tags:["medications","prescribing","renal dosing","drug interactions","beers","weight dosing","rsi","vasopressors","infusion","reversal","rx builder","ai pharmacist"],       features:["Rx Lookup · AI Summary","Weight & Drip Dosing","Interactions Checker","AI Pharmacist"],       desc:"Unified pharmacology hub — FDA Rx lookup, renal dosing, weight-based dosing, drip calculator, drug interactions, Rx builder, AI pharmacist." },
    ...
    { id:"drugcompare",route:"/DrugComparisonHub", isNew:true, icon:"🔬", title:"Drug Comparison Hub", badge:"SIDE-BY-SIDE", color:T.teal, tags:["drug","comparison","side by side","pharmacology","dosing","formulary","renal"], features:["Side-by-Side Compare","Renal Tier Overlay","Patient Parameters","Allergy Flags"], desc:"Compare up to 4 drugs side-by-side — dosing, renal tiers, contraindications, ISMP flags, patient-specific overlays." },
    { id:"medrec",     route:"/MedRecHub",          isNew:true, icon:"📋", title:"Med Reconciliation", badge:"AI·INTERACTIONS", color:T.purple, tags:["medication reconciliation","med rec","drug interaction","renal flag","hold list","allergy","home meds"], features:["Drug-Drug Interactions","Renal Flags","Hold List","Allergy Conflicts"], desc:"AI-powered medication reconciliation — flags DDIs, renal dosing issues, hold list, allergy conflicts between home and ED meds." },
    { id:"dischargerx",route:"/DischargeRxCard",    isNew:true, icon:"💊", title:"Discharge Rx Card",  badge:"DOSE·DURATION", color:T.gold, tags:["discharge","prescription","dose","duration","contraindications","patient instructions","avoid"], features:["Indication-Specific Duration","Absolute Contraindications","Return Precautions","Patient Instructions"], desc:"Generate discharge prescription cards with dose, duration, contraindications, what to avoid, and when to return to ED." },
    ]},
  ...
  { label:"Critical Protocols", color:"#f43f5e", hubs:[
    { id:"cp-sepsis",     route:"/SepsisHub",                 icon:"🦠", title:"Sepsis / Septic Shock",          badge:"SSC 2021",     color:"#f43f5e", tags:["sepsis","septic shock","hour-1","bundle","qsofa","sirs","vasopressor","lactate"],                      features:["Hour-1 Bundle","Source ABX","Vasopressor Ladder","qSOFA"],          desc:"SEP-1 Hour-1 bundle, source-based empiric antibiotics, norepinephrine ladder, POCUS." },
    ...
    { id:"cp-rsi",        route:"/AirwayRSIHub",              icon:"🌬️", title:"Airway / RSI",                   badge:"DAS 2022",     color:"#f43f5e", tags:["airway","rsi","intubation","lemon","moans","cric","cricothyrotomy","failed airway"],                    features:["LEMON · MOANS","7 Ps Drug Selector","Failed Airway A–D","Cric Kit"], desc:"LEMON/MOANS assessment, RSI 7-step drug selector, DAS 2022 failed airway algorithm, cric." },
    { id:"cp-status-epi", route:"/StatusEpilepticusHub",      icon:"⚡", title:"Status Epilepticus",             badge:"AES 2022",     color:"#a78bfa", tags:["status epilepticus","seizure","benzodiazepine","keppra","phenobarbital","propofol"],                      features:["5-Phase Ladder","Benzo Dosing","AED Selection","Refractory SE"],    desc:"5-phase treatment ladder: BZD → LEV/VPA → phenobarbital → anesthetic infusion. VITAMINS mnemonic." },
    { id:"cp-htn-em",     route:"/HypertensiveEmergencyHub",  icon:"🧠", title:"Hypertensive Emergency",         badge:"ACEP 2023",    color:"#a78bfa", tags:["hypertension","hypertensive emergency","MAP","nicardipine","labetalol","end-organ"],                    features:["9 Scenarios","Agent Selection","MAP Targets","End-Organ Assessment"], desc:"9 end-organ scenarios with targeted agent selection and MAP reduction targets." },
    { id:"cp-meningitis", route:"/MeningitisHub",             icon:"🧠", title:"Meningitis",                     badge:"IDSA 2020",    color:"#a78bfa", tags:["meningitis","lumbar puncture","ceftriaxone","dexamethasone","csf","encephalitis"],                      features:["Dex Before ABX","LP Interpretation","CSF Profiles","Empiric Coverage"],desc:"Dexamethasone before antibiotics, LP calculator, empiric coverage by age, CSF profiles." },
    { id:"cp-dka",        route:"/DKAHub",                    icon:"⚗️", title:"DKA / HHS",                      badge:"ADA 2022",     color:"#14b8a6", tags:["dka","diabetic ketoacidosis","hhs","insulin","anion gap","potassium","bicarbonate"],                    features:["AG Calculator","6 I's Causes","Fluid Protocol","Insulin + K⁺"],     desc:"Anion gap calculator, 6 I's causes, fluid resuscitation protocol, insulin + potassium replacement." },
    { id:"cp-hyperkalemia",route:"/HyperkalemiaHub",          icon:"⚗️", title:"Hyperkalemia",                   badge:"ACEP 2021",    color:"#14b8a6", tags:["hyperkalemia","potassium","kayexalate","calcium","insulin","albuterol","ecg","c-digfast"],              features:["C-DIGFAST","ECG Changes","Stabilize→Shift→Eliminate","Dialysis"],  desc:"C-DIGFAST mnemonic, ECG changes by K+ level, calcium stabilization, shift, eliminate protocol." },
    { id:"cp-rhabdo",     route:"/RhabdomyolysisHub",         icon:"⚗️", title:"Rhabdomyolysis",                 badge:"ACEP 2022",    color:"#14b8a6", tags:["rhabdomyolysis","ck","myoglobin","aki","compartment syndrome","ivf","muscle"],                         features:["CK Severity Classifier","MUSCLE Causes","IVF Calculator","AKI"],   desc:"CK severity grading, MUSCLE causes mnemonic, IVF calculator, AKI monitoring, compartment syndrome." },
    { id:"cp-pe",         route:"/MassivePEHub",              icon:"❤️", title:"Massive / Submassive PE",        badge:"ESC 2022",     color:"#3b82f6", tags:["pulmonary embolism","pe","massive pe","submassive pe","tpa","thrombolysis","spesi","perc","wells"],      features:["sPESI Score","Thrombolytic Decision","Anticoagulation Dosing","PERC+Wells"],desc:"sPESI calculator, thrombolytic decision tree for massive vs submassive PE, anticoagulation." },
    { id:"cp-adhf",       route:"/ADHFHub",                   icon:"❤️", title:"Acute Decompensated Heart Failure",badge:"ACC/AHA",    color:"#3b82f6", tags:["heart failure","adhf","chf","diuresis","nppv","furosemide","stevenson","inotropes"],                    features:["Stevenson Phenotypes","Diuretic Calculator","NPPV","Inotropes"],   desc:"Stevenson clinical profiles, diuretic dosing calculator, NPPV indications, inotrope selection." },
    { id:"cp-stemi",      route:"/STEMIHub",                  icon:"❤️", title:"STEMI",                          badge:"AHA 2022",     color:"#3b82f6", tags:["stemi","mi","pci","cath lab","door-to-balloon","lytics","fibrinolysis","reperfusion"],                  features:["Door-to-Balloon","Cath Lab Activation","Lytics Decision","Reperfusion"],desc:"Door-to-balloon timer, cath lab activation criteria, fibrinolysis decision tree, reperfusion." },
    { id:"cp-adrenal",    route:"/AdrenalCrisisHub",          icon:"🔬", title:"Adrenal Crisis",                 badge:"ACEP 2023",    color:"#f59e0b", tags:["adrenal crisis","adrenal insufficiency","hydrocortisone","cortisol","cosyntropin"],                      features:["4 I's Causes","Hydrocortisone Protocol","Cosyntropin Test","Monitoring"],desc:"Primary vs secondary adrenal crisis, hydrocortisone 100 mg IV, cosyntropin stimulation test." },
    { id:"cp-thyroid",    route:"/ThyroidStormHub",           icon:"🔬", title:"Thyroid Storm",                  badge:"ATA 2022",     color:"#f59e0b", tags:["thyroid storm","thyrotoxicosis","ptu","propylthiouracil","bwps","methimazole","iopanoic"],              features:["BWPS Calculator","PTU Before Iodine","Dexamethasone","Cooling"],   desc:"Burch-Wartofsky Point Scale calculator, PTU → iodine sequence, dexamethasone, beta-blockade." },
    { id:"cp-alf",        route:"/AcuteLiverFailureHub",      icon:"🔬", title:"Acute Liver Failure",            badge:"AASLD 2021",   color:"#f59e0b", tags:["acute liver failure","alf","nac","king's college","meld","encephalopathy","transplant","acetaminophen"], features:["King's College Criteria","NAC Protocol","HE Grading","Transplant"],desc:"King's College criteria, NAC protocol for APAP-induced ALF, HE grading, MELD, transplant criteria." },
    { id:"cp-opioid",     route:"/OpioidOverdoseHub",         icon:"☠️", title:"Opioid Overdose",               badge:"SAMHSA 2023",  color:"#fb923c", tags:["opioid","overdose","naloxone","narcan","fentanyl","methadone","buprenorphine","cows","suboxone"],         features:["Multi-Route Naloxone","Infusion Protocol","COWS Calculator","Buprenorphine Initiation"],desc:"Naloxone dosing by route, infusion protocol for long-acting opioids, COWS score, ED buprenorphine." },
    { id:"cp-alcohol",    route:"/AlcoholWithdrawalHub",      icon:"☠️", title:"Alcohol Withdrawal / DTs",       badge:"ASAM 2020",    color:"#fb923c", tags:["alcohol withdrawal","ciwa","delirium tremens","benzodiazepine","phenobarbital","seizure","wernicke"],    features:["CIWA Protocol","Benzo Ladder","Phenobarbital","DT Management"],   desc:"CIWA-Ar scoring, benzodiazepine symptom-triggered protocol, phenobarbital bridge, DT management." },
    { id:"cp-ttp",        route:"/TTPHub",                    icon:"🩸", title:"TTP / HUS",                      badge:"ASH 2022",     color:"#22c55e", tags:["ttp","hus","thrombotic thrombocytopenic purpura","adamts13","plasmapheresis","plt","blood smear"],       features:["ADAMTS13","Plasmapheresis Urgency","Avoid Platelets","Blood Smear"],desc:"ADAMTS13 deficiency, urgent plasmapheresis, avoid platelet transfusion, blood smear findings." },
    ...
    { id:"cp-pph",        route:"/PostPartumHemorrhageHub",   icon:"🤰", title:"Postpartum Hemorrhage",          badge:"ACOG 2022",    color:"#f472b6", tags:["postpartum hemorrhage","pph","uterotonic","oxytocin","bakri","mtp","uterus","obstetric"],              features:["Uterotonic Ladder","Massive Transfusion","Bakri Balloon","Surgical Escalation"],desc:"Uterotonic ladder: oxytocin → methylergonovine → misoprostol → carboprost, Bakri balloon, MTP." },
    { id:"cp-hellp",      route:"/HELLPHub",                  icon:"🤰", title:"HELLP Syndrome",                 badge:"ACOG 2021",    color:"#f472b6", tags:["hellp","hemolysis","elevated liver enzymes","low platelets","magnesium","steroids","preeclampsia"],    features:["Diagnosis Criteria","Delivery Timing","Magnesium","Steroid Protocol"],desc:"HELLP diagnosis triad, delivery timing, magnesium sulfate protocol, steroid thresholds." },
  ]},
  { label:"Documentation & Tools", color:T.purple, hubs:[
    ...
    { id:"ednote",     route:"/EdNoteGenerator",         isNew:true, icon:"📝", title:"ED Note Generator",  badge:"HPI·ROS·MDM",  color:T.teal,   tags:["note","ed note","hpi","ros","pe","mdm","documentation","chart","ehr"], features:["AI HPI Prose","Per-System ROS","PE by System","AI MDM"], desc:"Section-by-section ED note builder — AI-generated HPI and MDM, per-system ROS checkboxes, PE, and per-section EHR copy." },
    { id:"clinpres",   route:"/ClinicalPresentationHub", isNew:true, icon:"🏥", title:"Clinical Presentation Hub", badge:"EVIDENCE-BASED", color:T.blue, tags:["clinical","presentation","management","emergency","diagnosis","evidence","protocol","ED"], features:["Common ED Presentations","Evidence-Based Management","AI-Generated Guidance","Clinical Pearls"], desc:"Structured evidence-based management guidance for common ED presentations — workup, treatment, disposition, and clinical pearls." },
