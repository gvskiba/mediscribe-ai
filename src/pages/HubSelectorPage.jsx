...
const HUBS = [
  ...
  },
  {
    ...
    abbr: "LAB HUB",
    title: "Lab Hub",
    subtitle: "Interpret · Serial Trends · AI Analysis · KDIGO · Troponin Delta · Lactate Clearance",
    color: "#3dffa0",
    glow: "rgba(61,255,160,0.4)",
    glass: "rgba(61,255,160,0.07)",
    border: "rgba(61,255,160,0.28)",
    ...
    stats: ["10 Panels · AI Interp", "Serial Trends · Recharts", "KDIGO · Trop Delta"],
    badge: "AI·TRENDS",
    priority: 44,
  },
  {
  ...
  {
    id: "unified-pharma",
    route: "/unified-pharma",
    icon: "⚗",
    abbr: "PHARMA HUB",
    title: "Unified PharmacologyHub",
    subtitle: "Rx Lookup · FDA Labels · Weight Dosing · Drip Calc · Interactions · Rx Builder · AI Pharmacist",
    color: "#00b4d8",
    glow: "rgba(0,180,216,0.4)",
    glass: "rgba(0,180,216,0.07)",
  ...
  {
    id: "critical-drip",
    route: "/CriticalCareDripHub",
    icon: "💧",
    abbr: "DRIP HUB",
    title: "Critical Care Drip Hub",
    subtitle: "Vasopressor Titration · Shock Classification · Drip Rates · Titration Sheets",
    color: "#ff6060",
    glow: "rgba(255,96,96,0.4)",
    glass: "rgba(255,96,96,0.07)",
    border: "rgba(255,96,96,0.28)",
    accent: "#ff8888",
    category: "Critical Care",
    stats: ["Vasopressors", "Shock Types", "Titration Sheets"],
    badge: "ICU Tools",
    priority: 24.5,
    essential: false,
  },
  {
    ...
    route: "/FluidElectrolyteCalculator",
    icon: "🧪",
    abbr: "FLUIDS",
    title: "Fluid & Electrolyte Calc",
    subtitle: "Na Deficit · Free Water · K Replacement · Bicarb · Anion Gap · Osmolality",
    color: "#4ade80",
    ...
    accent: "#6fffaa",
    category: "Pharmacology",
    stats: ["Na/K/HCO3", "Anion Gap", "Osmol Gap"],
    badge: "Live",
    priority: 41.3,
    essential: false,
  },
  {
    id: "abx-stewardship",
    route: "/AntibioticStewardshipHub",
    icon: "💉",
    abbr: "ABX STEWARD",
    title: "Antibiotic Stewardship",
    subtitle: "Empiric Regimens · PCN Allergy Alts · De-escalation · Culture-Guided AI",
    color: "#3dffa0",
    glow: "rgba(61,255,160,0.4)",
    glass: "rgba(61,255,160,0.07)",
    border: "rgba(61,255,160,0.28)",
    accent: "#6fffbb",
    category: "Pharmacology",
    stats: ["Empiric ABX", "Allergy Alts", "AI De-escalation"],
    badge: "Live",
    priority: 41.4,
    essential: false,
  },
  {
    ...
    abbr: "DENTAL",
    title: "Dental Hub",
    subtitle: "Dental Emergencies · Tooth Fractures · Pericoronitis · Abscess · Nerve Blocks",
    color: "#00b4d8",
    glow: "rgba(0,180,216,0.4)",
    glass: "rgba(0,180,216,0.07)",
    border: "rgba(0,180,216,0.28)",
  ...
  {
    id: "drug-comparison",
    route: "/DrugComparisonHub",
    icon: "⚖",
    abbr: "DRUG COMPARE",
    title: "Drug Comparison Hub",
    subtitle: "Side-by-side drug analysis · Renal tiers · Interactions · ISMP flags",
    color: "#00b4d8",
    glow: "rgba(0,180,216,0.4)",
    glass: "rgba(0,180,216,0.07)",
    border: "rgba(0,180,216,0.28)",
    accent: "#33c8e8",
    category: "Pharmacology",
    stats: ["Side-by-Side", "Renal Tiers", "ISMP Flags"],
    badge: "Live",
    priority: 41.6,
    essential: false,
  },
  {
    ...
    subtitle: "AI-powered med rec · Drug interactions · Renal flags · Hold list · Allergy conflicts",
    color: "#00b4d8",
    glow: "rgba(0,180,216,0.4)",
    glass: "rgba(0,180,216,0.07)",
    border: "rgba(0,180,216,0.28)",
    accent: "#33c8e8",
    category: "Pharmacology",
    stats: ["Drug Interactions", "Renal Flags", "Hold List"],
    badge: "AI-Powered",
    priority: 41.7,
    essential: false,
  },
  {
    ...
    icon: "🦠",
    abbr: "SEP-1",
    title: "Sepsis Bundle Tracker",
    subtitle: "CMS SEP-1 compliance · Real-time bundle tracking · Hour-1 interventions · Quality log",
    color: "#f5c842",
    glow: "rgba(245,200,66,0.4)",
    glass: "rgba(245,200,66,0.07)",
    border: "rgba(245,200,66,0.28)",
    accent: "#f7d875",
    category: "Critical Care",
    stats: ["SEP-1 Compliance", "Hour-1 Bundle", "Quality Log"],
    badge: "CMS SEP-1",
    priority: 12.5,
    essential: false,
  },
...
const LIVE_ROUTES = new Set([
  ...
  "/DentalHub", "/DyspneaHub", "/HeadacheHub", "/AbdominalPainHub",
  "/ams-hub", "/syncope-hub", "/dvt-hub", "/score-hub", "/pain-hub",
  "/weight-dose", "/SepsisHub", "/LabHub", "/imaging-interpreter",
