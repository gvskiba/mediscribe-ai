...
const _STUB = [{ id:"ketamine_pain", category:"analgesics", name:"Ketamine", subtitle:"Sub-dissociative Analgesic", code:"KET-SD", line:"first", indications:["Acute pain","Procedural sedation"], adult_dose:"0.1–0.3 mg/kg IV over 10 min", ped:{mgkg:0.3,unit:"mg",route:"IV",max:30,notes:"Over 10 min"}, onset:"1–2 min IV", duration:"15–30 min", contraindications:["Elevated ICP","Schizophrenia","STEMI"], warnings:["Emergence reactions — consider midazolam 0.05 mg/kg","Increased secretions — consider atropine"], monitoring:["HR","BP","O₂ sat","Mental status on emergence"], reversal:null, refs:["ACEP 2019","EM:RAP"] },
  ...
  { id:"sodium_bicarb", category:"gi_gu_ob", name:"Sodium Bicarbonate", subtitle:"Alkalinizing Agent · Toxicology", code:"SB-TOX", line:"first", indications:["TCA overdose","Hyperkalemia cardiac toxicity","Severe metabolic acidosis","Salicylate toxicity"], adult_dose:"TCA: 1–2 mEq/kg IV bolus (target pH 7.45–7.55) | Hyperkalemia: 1 mEq/kg IV", ped:{mgkg:1,unit:"mEq",route:"IV/IO",max:100,notes:"Dilute 1:1 in peds to reduce osmolality"}, onset:"Minutes", duration:"Rate-dependent", contraindications:["Metabolic alkalosis","Uncorrected hypocalcemia"], warnings:["Hypernatremia","Alkalosis overshoot — worsens ionized hypocalcemia","Tissue necrosis if extravasated"], monitoring:["ABG/VBG target pH 7.45–7.55 (TCA)","Na+","K+","iCa2+","ECG"], reversal:null, refs:["ACEP Tox 2021"] },
];
