...
const _JUNK = [{ id:"fentanyl", category:"analgesics", name:"Fentanyl", subtitle:"Opioid Analgesic", code:"FEN-IV", line:"first", indications:["Moderate–severe pain","Procedural sedation adjunct"], adult_dose:"1–2 mcg/kg IV q30–60min PRN", ped:{mgkg:1.5,unit:"mcg",route:"IV/IN",max:100,notes:"IN: 2 mcg/kg max 100 mcg"}, onset:"1–2 min IV", duration:"30–60 min", contraindications:["Respiratory depression","MAO inhibitors within 14 days"], warnings:["Chest wall rigidity at high doses","Naloxone reversal available"], monitoring:["RR","O₂ sat","LOC"], reversal:"Naloxone 0.01 mg/kg IV", refs:["ACEP","WHO"] },
