...
export default function NewPatientInput() {
  ...
  const renderContent = () => {
    switch (currentTab) {
      ...
      case "erx": return <div style={{ margin: "-18px -28px", height: "calc(100% + 36px)", overflow: "hidden" }}><ERxHub embedded patientAllergiesFromParent={allergies} patientWeightFromParent={vitals.weight || ""} /></div>;
