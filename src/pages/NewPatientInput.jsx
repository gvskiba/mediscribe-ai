    ...
    <div className="npi-root">
      ...
      <nav className="npi-nav">
        ...
        <div className="npi-nav-right">
          ...
          <div className="npi-avatar">{SIDEBAR_ITEMS.find(item => item.id === currentTab)?.icon || '📋'}</div>
        </div>
      </nav>
