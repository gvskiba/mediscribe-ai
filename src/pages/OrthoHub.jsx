  ...
  return (
    <div style={{display:"flex",minHeight:"100vh",background:T.bg,color:T.txt}}>
      ...
      <div style={{flex:1,overflow:"auto",display:"flex",flexDirection:"column",minWidth:0,position:"relative"}}>
        <AmbientBg/>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",paddingRight:16}}><NotryaHubHeader hubName="Ortho Hub" category="Procedures" homeUrl="/" /><PulseNavBadge /></div>
        <NotryaPatientBar />
