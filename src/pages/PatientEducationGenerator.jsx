...
.peg-level-opt{flex:1;padding:20px 8px 18px;text-align:center;cursor:pointer;transition:.15s;border:1px solid var(--border2);border-radius:8px;font-size:12px;color:var(--text2);font-weight:500;line-height:1.4;background:var(--bg5);}
