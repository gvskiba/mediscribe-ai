...
export default function PediatricDosing() {
  ...
  const SEARCH_ALIASES = {
    ...
    'lyme': 'Lyme doxycycline',
    'tick': 'Lyme RMSF doxycycline',
    'rocky mountain': 'RMSF doxycycline',
    'constipation': 'constipation PEG MiraLax',
    'reflux': 'GERD omeprazole',
    'gerd': 'GERD omeprazole',
    'dehydration': 'dehydration oral rehydration Pedialyte',
    'gastroenteritis': 'gastroenteritis rehydration ondansetron',
    'itchy': 'pruritus urticaria hydroxyzine diphenhydramine',
    'anxiety': 'anxiety hydroxyzine',
    'overdose': 'reversal naloxone flumazenil',
    'opioid overdose': 'opioid naloxone reversal',
    'low blood sugar': 'hypoglycemia dextrose glucagon',
    'hypoglycemia': 'hypoglycemia dextrose glucagon',
    'beta blocker': 'glucagon beta-blocker overdose',
    'intubation': 'RSI etomidate rocuronium succinylcholine ketamine',
    'procedural sedation': 'propofol ketamine dexmedetomidine midazolam',
    'icu sedation': 'dexmedetomidine propofol',
    'neutropenia': 'febrile neutropenia pip-tazo piperacillin',
    'appendicitis': 'piperacillin metronidazole anaerobic',
    'abdominal': 'anaerobic metronidazole piperacillin',
    'utis': 'UTI cephalexin TMP-SMX nitrofurantoin',
    'pneumonia outpatient': 'CAP amoxicillin azithromycin',
  };
