// QuickNoteBanners.jsx — Status banners for QuickNote (undo, NH-Resume, VH import, VH analysis, addendum)
export default function QuickNoteBanners({
  showUndo, undoData, undoTimer, onUndo, onDismissUndo,
  nhResumed, nhResumeDismissed, onDismissNhResume,
  vhImported, vhDismissed, onDismissVh,
  vhAnalysis, vhAnalysisDismissed, onDismissVhAnalysis,
    ...
    <>
      ...
      {nhResumed && !nhResumeDismissed && (
        <div style={{ marginBottom:10, padding:"8px 14px", borderRadius:10,
          ...
          <button onClick={onDismissNhResume}
            style={{ background:"transparent", border:"none", cursor:"pointer",
              fontFamily:"'JetBrains Mono',monospace", fontSize:11,
              color:"var(--qn-txt4)", padding:"0 4px" }}>✕</button>
        </div>
      ...
      {vhAnalysis && !vhAnalysisDismissed && (
        <div style={{ marginBottom:10, padding:"12px 14px", borderRadius:10,
          ...
          <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:8 }}>
            ...
            <div style={{ flex:1 }} />
            <button onClick={onDismissVhAnalysis}
              style={{ background:"transparent", border:"none", cursor:"pointer",
                fontFamily:"'JetBrains Mono',monospace", fontSize:11,
                color:"var(--qn-txt4)", padding:"0 4px" }}>✕</button>
          </div>
